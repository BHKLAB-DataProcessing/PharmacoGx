...
RUN Rscript -e "library(BiocManager); install(c('multtest', 'NMF', 'rmarkdown', 'RColorBrewer'))"
RUN Rscript -e "library(devtools); install_url('http://research-pub.gene.com/gCSI-cellline-data/compareDrugScreens_current.tar.gz')"
